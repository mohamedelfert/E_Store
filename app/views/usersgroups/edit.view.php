        ...
        <div class="text-center">
            <form class="app_form" method="post" enctype="application/x-www-form-urlencoded">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <h3 class="register-heading"> <?= $text_edit_group ?> </h3>
                    <div class="row register-form">
                        <div class="form-group col-md-12">
                            <label class="control-label col-sm-2" for="groupName"> <?= $text_group_name ?>  :  </label>
                            <label class="control-label col-sm-9">
                                <input type="text" class="form-control" placeholder="<?= $text_group_name ?> *" name="groupName" id="groupName" required value="<?= $groups->GroupName ?>"/>
                            </label>
                        </div>
                        <div class="container">
                            ...
                            if ($privileges !== false){
                                foreach($privileges as $privilege){
                                    ...
                                    <div class="input-group">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="privilege[]" id="privilege[]" <?= in_array($privilege->PrivilegeId, $groupsPrivileges) ? 'checked' : '' ?> value="<?= $privilege->PrivilegeId ?>">
