                        ...
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="text" class="form-control" placeholder="<?= $text_label_Username ?> *" name="Username" id="Username" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="password" class="form-control" placeholder="<?= $text_label_Password ?> *" name="Password" id="Password" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="password" class="form-control" placeholder="<?= $text_label_CPassword ?> *" name="CPassword" id="CPassword" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="email" class="form-control" placeholder="<?= $text_label_Email ?> *" name="Email" id="Email" maxlength="40" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="email" class="form-control" placeholder="<?= $text_label_CEmail ?> *" name="CEmail" id="CEmail" maxlength="40" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="text" class="form-control" placeholder="<?= $text_label_PhoneNumber ?> *" name="PhoneNumber" id="PhoneNumber" maxlength="11" required />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
