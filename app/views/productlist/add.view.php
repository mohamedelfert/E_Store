                    ...
                    <div class="row register-form">
                        <div class="form-group col-md-6">
                            ...
                            <label class="control-label col-sm-12">
                                <input type="text" class="form-control" placeholder="<?= $text_label_ProductName ?> *" name="ProductName" id="ProductName" required value="<?= $this->showValue('ProductName') ?>"/>
                            </label>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <label class="control-label col-sm-12">
                                <input type="number" class="form-control" min="1" step="1" name="Quantity" id="Quantity" required value="<?= $this->showValue('Quantity') ?>"/>
                            </label>
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label col-sm-12" for="BuyPrice"> <?= $text_label_BuyPrice ?>  :  </label>
                            <label class="control-label col-sm-12">
                                <input type="number" class="form-control" min="1" step="0.01" name="BuyPrice" id="BuyPrice" required value="<?= $this->showValue('BuyPrice') ?>"/>
                            </label>
                        </div>
                        <div class="form-group col-md-2">
                            <label class="control-label col-sm-12" for="SellPrice"> <?= $text_label_SellPrice ?>  :  </label>
                            <label class="control-label col-sm-12">
                                <input type="number" class="form-control" min="1" step="0.01" name="SellPrice" id="SellPrice" required value="<?= $this->showValue('SellPrice') ?>"/>
                            </label>
                        </div>
                        <div class="form-group col-md-6">
                            <div class="form-group col-md-12">
