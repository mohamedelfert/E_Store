                    ...
                    <div class="row register-form">
                        <div class="col-md-6">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="text" class="form-control" placeholder="<?= $text_label_SupplierName ?> *" name="SupplierName" id="SupplierName" required value="<?= $this->showValue('SupplierName', $supplier) ?>" />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group col-md-12">
                                ...
                                <label class="control-label col-sm-12">
                                    <input type="text" class="form-control" placeholder="<?= $text_label_SupplierAddress ?> *" name="SupplierAddress" id="SupplierAddress" required value="<?= $this->showValue('SupplierAddress', $supplier) ?>" />
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6">
